...
import { clearCart, minusPizzaCount, plusPizzaCount, removeItem } from '../redux/actions/cart';
...
function Cart() {
  ...
  const onPlusPizzaCount = (id) => {
    dispatch(plusPizzaCount(id));
  };
          ...
          {pizzas.map((item) => {
            return (
              <CartItem
                ...
                onPlusCount={onPlusPizzaCount}
                onMinusCount={onMinusPizzaCount}
              />
            );
          })}
